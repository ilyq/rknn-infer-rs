...
rm -rf rknn_mobilenet_infer_demo_arm

$CXX \
    rknn_mobilenet_infer_demo.cpp \
    -o rknn_mobilenet_infer_demo_arm \
...
echo "完成！输出文件: rknn_mobilenet_infer_demo_arm"
file rknn_mobilenet_infer_demo_arm
